...
router = APIRouter(prefix="/api/module-logs", tags=["module-logs"])  # mounts module log endpoints
...
async def get_module_logs_summary(
    ...
    scope = _get_scope(module_id)  # resolve to scope; raises 404 if not found
