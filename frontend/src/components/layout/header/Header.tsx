...
import { ROUTE_KEYS } from './ROUTE_KEYS.constant'
...
export default function Header() {
  ...
  const degraded = health.checkedAt !== null && (!health.api || !health.postgres || !health.clickhouse) // Show alert only after first check
