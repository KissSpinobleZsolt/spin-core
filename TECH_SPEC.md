# spin-core — Technical Specification

Reference for developers, integrators, and operators. For a plain-language overview of what the platform does, see [README.md](README.md).
...
Install only what matches your chosen run mode.
